...
public class ObjectPlacer : MonoBehaviour
{
    ...
    public List<PlacementQuery> AddBuildings()
    {
        ...
        var queries = CreateLocationQueriesForSolver(ObjectCollectionManager.Instance.HotSpotPrefabs.Count, ObjectCollectionManager.Instance.HotSpotSize, ObjectType.WideBuilding);
        ...
        if (_results.Count > 0)
        {
            ...
            switch (toPlace.ObjType)
            {
                ...
                case ObjectType.WideBuilding:
                    ObjectCollectionManager.Instance.CreateHotSpot(_placedWideBuilding++, toPlace.Position, rotation);
                    break;
